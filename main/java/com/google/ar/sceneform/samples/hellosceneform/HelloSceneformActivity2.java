 ...
 */
public class HelloSceneformActivity2 extends AppCompatActivity {
  private static final String TAG = HelloSceneformActivity2.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ModelRenderable.builder()
      ...
      ViewRenderable.builder()
              .setView(this,R.layout.test_view2)
              .build()
