 ...
 */
public class HelloSceneformActivity6 extends AppCompatActivity {
  private static final String TAG = HelloSceneformActivity6.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ModelRenderable.builder()
        .setSource(this, R.raw.renault_ag_1906)
        .build()
      ...
      ViewRenderable.builder()
              .setView(this,R.layout.test_view6)
              .build()
