 ...
 */
public class HelloSceneformActivity3 extends AppCompatActivity {
  private static final String TAG = HelloSceneformActivity3.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ModelRenderable.builder()
      ...
      ViewRenderable.builder()
              .setView(this,R.layout.test_view3)
              .build()
