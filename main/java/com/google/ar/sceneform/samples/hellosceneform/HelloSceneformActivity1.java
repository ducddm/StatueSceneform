 ...
 */
public class HelloSceneformActivity1 extends AppCompatActivity {
  private static final String TAG = HelloSceneformActivity1.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ModelRenderable.builder()
      ...
      ViewRenderable.builder()
              .setView(this,R.layout.test_view1)
              .build()
