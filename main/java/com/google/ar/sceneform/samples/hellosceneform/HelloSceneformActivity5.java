 ...
 */
public class HelloSceneformActivity5 extends AppCompatActivity {
  private static final String TAG = HelloSceneformActivity5.class.getSimpleName();
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ModelRenderable.builder()
      ...
      ViewRenderable.builder()
              .setView(this,R.layout.test_view5)
              .build()
